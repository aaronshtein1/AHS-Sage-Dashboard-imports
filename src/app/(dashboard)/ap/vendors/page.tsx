  ...
  return (
    <div className="p-8">
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-zinc-900">Vendors</h1>
          <p className="mt-1 text-sm text-zinc-600">Manage your vendor contacts</p>
        </div>
        <Button
          onClick={() => {
            resetForm();
      ...
      {isLoading ? (
        ...
        <Card className="p-12 text-center">
          ...
          <p className="text-sm text-zinc-500 mt-1">Create your first vendor to get started</p>
        </Card>
      ) : (
